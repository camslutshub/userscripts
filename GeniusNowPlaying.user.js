...
$(function () {
    ...
    if (!username || !fmkey || !geniuskey) {
        $(".HomeContentdesktop__CenteredFlexColumn-sc-1xfg7l1-1.hgPKGH").prepend("<div id='gnp-config' style='padding-top: 72px; text-align: center;'><p>Thank you for installing GeniusNowPlaying! To get started, please enter the following values:</p></div>");
    };
