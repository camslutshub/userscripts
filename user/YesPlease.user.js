...
(function () {
  GM_config.init({
    ...
    fields: {
      ...
      hash: {
        ...
        type: 'text',
        title: 'Valid subscription identifier, required when using the official host',
        size: 64,
        default: 'abcdefghijklmnopqrstuvwxyz1234567890abcdefghijklmnopqrstuvwxyz12'
      },
      'group-newsletter': {
      ...
      'group-rating': {
        ...
        type: 'checkbox',
        title: "Block website ratings, 'website protected by...' and similar boxes",
        default: true
      },
      'group-translation': {
      ...
      'group-suggestion': {
        ...
        type: 'checkbox',
        title: 'Block pop-ups offering shopping, reading and similar suggestions',
        default: true
      },
      'group-iam18': {
        label: 'Age confirmations',
        type: 'checkbox',
        title: 'Automatically confirm you are 18+ years old when needed, if you really are',
        default: false
      },
      version: {
        label: 'Rules version',
        ...
        type: 'text',
        title: 'Version of the currently cached rules file, will be updated automatically',
        size: 7,
        default: '0.0.0.0'
      },
      rules: {
      ...
      update: {
        ...
        type: 'int',
        title: 'Interval in milliseconds in which to automatically check for updates',
        default: 86400000
      },
      notify: {
  ...
  GM.registerMenuCommand('Report issue on this page', () => {
    GM.openInTab('https://www.no-thanks-extension.com/report/problem/on/' + encodeURIComponent(encodeURIComponent(location.href)), {
      active: true
    })
  })
